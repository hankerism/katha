          ...
          <div className="mt-5 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {categories.map((category) => (
              ...
              >
                <span
                  aria-hidden="true"
                  className="pointer-events-none absolute -right-1 -top-3 select-none font-logo text-6xl font-semibold leading-none text-accent/10 transition-all duration-300 ease-out motion-safe:group-hover:-top-2 group-hover:text-accent/20"
                >
