...
import StudioEmptyState from '@/components/studio/dashboard/EmptyState';

/* ---------------------------------------------------------------------------
 * KATHA · Author Studio — all works
 * app/studio/works/page.tsx
 *
 * The full shelves: every work, organized by where it stands — drafts on the
 * desk, published works in the library, the archive folded away at the
 * bottom. This is the "View all" destination from the Studio dashboard
 * (app/studio/page.tsx), which shows only the most recent activity.
 *
 * The shelf sections moved here verbatim from the original Studio home when
 * the dashboard took the landing spot — same organization, same voice.
 * Client component (works live in localStorage) with the house mount-gate.
 * ------------------------------------------------------------------------- */
      ...
      <header className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-xl font-body text-base leading-relaxed text-muted-foreground">
            Everything you have written, shelved by where it stands.
          </p>
        </div>
