...
const AUTHORED_AUTHORS: KathaAuthor[] = [
  ...
  {
    id: 'auth-cesar-madrigal',
    userId: null,
    slug: 'cesar-madrigal',
    displayName: 'Cesar Madrigal',
    bio: 'Former building administrator; current professional noticer. Writes mysteries in which the crime is quiet, the clues are on a list, and the elevator hears everything.',
    location: 'Naga',
    avatar: null,
    banner: null,
  },
